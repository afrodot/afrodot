...
nc.countdown = function (obj) {
	...
	countdownHtml += '	 <div class="digit">4</div>';
	countdownHtml += '	 </div>';
	...
	countdownHtml += '	 <div class="inner-dash">';
	countdownHtml += '	 <div class="digit">3</div>';
	countdownHtml += '	 <div class="digit">8</div>';
	countdownHtml += '	 </div>';
	...
	countdownHtml += '	 <div class="inner-dash">';
	countdownHtml += '	 <div class="digit">5</div>';
	countdownHtml += '	 <div class="digit">6</div>';
	countdownHtml += '	 </div>';
